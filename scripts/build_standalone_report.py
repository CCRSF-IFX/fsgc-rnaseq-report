...
def annotate_fsgc_rsem_assets(assets: dict[str, str], virtual_data_root: str) -> None:
    root = Path(virtual_data_root)
    merge_json_asset(assets, (root / "logs/pipeline_provenance.json").as_posix(), {
    ...
    merge_json_asset(assets, (root / "logs/software_versions.json").as_posix(), {
