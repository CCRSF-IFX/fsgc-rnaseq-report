...
function deAnalysisCacheEntry(contrast) {
  ...
  return {
    ...
    interaction_output: contrast.interaction_output || '',
    interaction_output_label: contrast.interaction_output_label || '',
    interaction_result_id: contrast.interaction_result_id || '',
    interaction_outputs: contrast.interaction_outputs || [],
